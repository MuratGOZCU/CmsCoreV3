...
namespace CmsCoreV2.Areas.CmsCore.Controllers
{
    ...
    public class PostsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create([Bind("SmallPhoto,Title,Slug,Body,Description,Position,Photo,Meta1,Meta2,ViewCount,HeaderScript,SeoTitle,SeoDescription,SeoKeywords,IsPublished,LanguageId,PublishDate,Id,CreateDate,CreatedBy,UpdateDate,UpdatedBy,AppTenantId")] Post post, string categoriesHidden)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("SmallPhoto,Title,Slug,Body,Description,Position,Photo,Meta1,Meta2,ViewCount,HeaderScript,SeoTitle,SeoDescription,SeoKeywords,IsPublished,LanguageId,PublishDate,Id,CreateDate,CreatedBy,UpdateDate,UpdatedBy,AppTenantId")] Post post, string categoriesHidden)
        {
            if (id != post.Id)
            {
                return NotFound();
