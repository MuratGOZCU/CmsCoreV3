...
namespace CmsCoreV2.Areas.CmsCore.Controllers
{
    ...
    public class PagesController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create([Bind("Title,Slug,Body,Position,ViewCount,ParentPageId,Photo,Meta1,Meta2,LayoutTemplate,HeaderScript,SeoTitle,SeoDescription,SeoKeywords,IsPublished,Template,LanguageId,Id,CreateDate,CreatedBy,UpdateDate,UpdatedBy,AppTenantId")] Page page)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Title,Slug,Body,Position,ViewCount,ParentPageId,Photo,Meta1,Meta2,LayoutTemplate,HeaderScript,SeoTitle,SeoDescription,SeoKeywords,IsPublished,Template,LanguageId,Id,CreateDate,CreatedBy,UpdateDate,UpdatedBy,AppTenantId")] Page page)
        {
            if (id != page.Id)
            {
                return NotFound();
