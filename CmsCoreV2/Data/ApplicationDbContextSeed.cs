    ...
    public static class ApplicationDbContextSeed
    {
        ...
        private static void AddPosts(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
                ...
                new Post { CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, Body = "<h3>1914 translation by H. Rackham</h3>", Description = "st, every pleasure is to be welcomed and every pain avoided. But in certain circumstances and owing to the claims of duty or the obligations of business it will frequently occur that pleasures ha", IsPublished = true, LanguageId = 1, Meta1 = "a", Meta2 = "a", Photo = "https://openclipart.org/image/2400px/svg_to_png/193409/1399740906.png", SeoDescription = "a", SeoKeywords = "a", SeoTitle = "a", Slug = "kameralar-geldi", Title = "Kameralar geldi", ViewCount = 0, AppTenantId = tenant.AppTenantId }
        ...
        private static void AddGalleryItems(ApplicationDbContext context,AppTenant tenant)
        {
            ...
            context.AddRange(
                new GalleryItem { Title = "flat1", Description = "flat 1", Position = 1, Photo = "https://colorlib.com/wp/wp-content/uploads/sites/2/2013/10/hudddle-logo.png",Video=null,Meta1= "grid-item-height1", GalleryId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                new GalleryItem { Title = "Empt", Description = "Empt", Position = 11, Photo = "http://jbcdn2.b0.upaiyun.com/2017/03/752e838aa02e32c905899447c7cfeb1f.jpeg", Video = null, Meta1 = "grid-item-height1", GalleryId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                new GalleryItem { Title = "bono", Description = "bono", Position = 7, Photo = "https://s-media-cache-ak0.pinimg.com/736x/ff/05/81/ff05811f23c9dda161730ac8b9688009.jpg", Video = null, Meta1 = "grid-item-height1", GalleryId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                new GalleryItem { Title = "kitcube", Description = "kit", Position = 6, Photo = "http://blog.karachicorner.com/wp-content/uploads/2013/08/longshadow-flat-design-9.jpg", Video = null, Meta1 = "grid-item-height1", GalleryId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                new GalleryItem { Title = "sch", Description = "sch", Position = 8, Photo = "https://s-media-cache-ak0.pinimg.com/originals/b0/6c/25/b06c2519ce91e1d0f35fa65df3cc84ce.png", Video = null, Meta1 = "grid-item-height1", GalleryId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                new GalleryItem { Title = "m-W", Description = "m-W", Position = 11, Photo = "https://cdn.dribbble.com/users/219762/screenshots/1554839/abstract_logo_1x.png", Video = null, Meta1 = "grid-item-height1", GalleryId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                new GalleryItem { Title = "catarse", Description = "cat", Position = 15, Photo = "https://s3.amazonaws.com/cdn.catarse/assets/logo-v-cor-negativo.png", Video = null, Meta1 = "grid-item-height1", GalleryId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                new GalleryItem { Title = "brand", Description = "brand", Position = 11, Photo = "http://zllox.com/wp-content/uploads/2016/04/Brand-Logo-Design.png", Video = null, Meta1 = "grid-item-height1", GalleryId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                ...
                new GalleryItem { Title = "joystick", Description = "x", Position = 12, Photo = "http://creativeadi.com/wp-content/uploads/2015/10/super_nintendo_ios_flat_app_icon.png", Video = null, Meta1 = "grid-item-height1", GalleryId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                new GalleryItem { Title = "fox", Description = "f", Position = 113, Photo = "https://s-media-cache-ak0.pinimg.com/736x/ae/bc/4a/aebc4a51bcf0736551b8fc34e55345a5.jpg", Video = null, Meta1 = "grid-item-height1", GalleryId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                new GalleryItem { Title = "dc", Description = "DC", Position = 14, Photo = "http://cdn.designbeep.com/wp-content/uploads/2013/10/7.long-shadow-flat-logo.png", Video = null, Meta1 = "grid-item-height1", GalleryId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                new GalleryItem { Title = "slug", Description = "sl", Position = 15, Photo = "http://designwebkit.com/wp-content/uploads/2013/07/flat-design-examples-logo-17.jpg", Video = null, Meta1 = "grid-item-height1", GalleryId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                new GalleryItem { Title = "Kalem", Description = "a", Position = 18, Photo = "http://blog.presentationload.com/wp-content/uploads/2015/09/Flat-Design-Shadow-Text.png", Video = null, Meta1 = "grid-item-height1", GalleryId = 2, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                ...
                new GalleryItem { Title = "dikey", Description = "s", Position = 17, Photo = "http://www.talonx.com/file/2014/07/talonX-Logo-Design-Menu.png", Video = null, Meta1 = "grid-item-height1", GalleryId = 2, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                new GalleryItem { Title = "web", Description = "webtrend", Position = 17, Photo = "http://www.kordahitechnologies.com/sites/default/files/Trending%20Web%20Design11.png", Video = null, Meta1 = "grid-item-height1", GalleryId = 2, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId }
