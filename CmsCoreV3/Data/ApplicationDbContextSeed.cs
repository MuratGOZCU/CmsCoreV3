    ...
    public static class ApplicationDbContextSeed
    {
        public static void Seed(this ApplicationDbContext context, IHttpContextAccessor accessor)
        {
            ...
            { 
                ...
                string[] bilgiKolejiTenants = { "BilgiKoleji", "Atasehir", "Maltepe", "Mersin" };

                if (bilgiKolejiTenants.Contains(tenant.Name))
                {
                    ...
                    var defaultLanguageId = BilgiKoleji_AddLanguages(context, tenant);
                    BilgiKoleji_AddPages(context, tenant, defaultLanguageId);

                    BilgiKoleji_AddSettings(context, tenant);           
                    BilgiKoleji_AddCustomization(context, tenant);
                    BilgiKoleji_AddMenus(context,tenant);            
                    BilgiKoleji_AddMenuItems(context,tenant);
                    BilgiKoleji_AddResources(context, tenant);

                    BilgiKoleji_AddHomePageSlider(context, tenant);
                    BilgiKoleji_AddHomePageSlides(context, tenant);
                    BilgiKoleji_AddSecondarySlider(context, tenant);
                    BilgiKoleji_AddSecondarySlides(context, tenant);
                    BilgiKoleji_AddLogoSlider(context, tenant);
                    BilgiKoleji_AddLogoSlides(context, tenant);

                    BilgiKoleji_AddForms(context,tenant);
                    BilgiKoleji_AddFormFields(context, tenant);

                    BilgiKoleji_AddGalleries(context, tenant);
                    BilgiKoleji_AddGalleryItems(context, tenant);
                    BilgiKoleji_AddGalleryItemCategories(context, tenant);
                    BilgiKoleji_AddGalleryItemGalleryItemCategories(context, tenant);

                    BilgiKoleji_AddPosts(context, tenant);
                ...
                else if (tenant.Name == "BilgiDil")
                {
                    ...
                    // Perform seed operations
                    var defaultLanguageId = BirInsanBelge_AddLanguages(context, tenant);
                    BirInsanBelge_AddPages(context, tenant, defaultLanguageId);

                    BirInsanBelge_AddSettings(context, tenant);
                    BirInsanBelge_AddCustomization(context, tenant);
                    BirInsanBelge_AddMenus(context, tenant);
                    BirInsanBelge_AddMenuItems(context, tenant);
                    BirInsanBelge_AddResources(context, tenant);

                    BirInsanBelge_AddHomePageSlider(context, tenant);
                    BirInsanBelge_AddHomePageSlides(context, tenant);
                    BirInsanBelge_AddSecondarySlider(context, tenant);
                    BirInsanBelge_AddSecondarySlides(context, tenant);
                    BirInsanBelge_AddLogoSlider(context, tenant);
                    BirInsanBelge_AddLogoSlides(context, tenant);

                    BirInsanBelge_AddForms(context, tenant);
                    BirInsanBelge_AddFormFields(context, tenant);

                    BirInsanBelge_AddGalleries(context, tenant);
                    BirInsanBelge_AddGalleryItems(context, tenant);
                    BirInsanBelge_AddGalleryItemCategories(context, tenant);
                    BirInsanBelge_AddGalleryItemGalleryItemCategories(context, tenant);

                    BirInsanBelge_AddPosts(context, tenant);
                    BirInsanBelge_AddPostCategories(context, tenant);
                    BirInsanBelge_AddPostPostCategories(context, tenant);
                    ...
                    // Perform seed operations
                    var defaultLanguageId = BilgiStore_AddLanguages(context, tenant);
                    BilgiStore_AddPages(context, tenant, defaultLanguageId);
                    
                    BilgiStore_AddSettings(context, tenant);
                    BilgiStore_AddCustomization(context, tenant);
                    BilgiStore_AddMenus(context, tenant);
                    BilgiStore_AddMenuItems(context, tenant);
                    
                    BilgiStore_AddHomePageSlider(context, tenant);
                    BilgiStore_AddHomePageSlides(context, tenant);
                }
        ...
        public static long BilgiKoleji_AddLanguages(ApplicationDbContext context, AppTenant tenant)
        {
            // add Turkish and English languages
            var l = new Language();
            l.Name = "Turkish";
            l.NativeName = "Türkçe";
            l.Culture = "tr";
        ...
        public static void BilgiKoleji_AddPages(ApplicationDbContext context, AppTenant tenant, long languageId)
        {
            ...
            context.AddRange(
               ...
               new Page {
                   Title = "İngilizce Laboratuvarı",
                   Slug = "ingilizce-laboratuvari",
                   ParentPageId = 15,
                   Template = "Page",
                   LanguageId = 1,
                   IsPublished = true,
               ...
               new Page {
                   Title = "Bilişim Laboratuvarı ",
                   Slug = "bilisim-laboratuvarı",
                   ParentPageId = 15,
                   Template = "Page",
                   LanguageId = 1,
                   IsPublished = true,
               ...
               new Page {
                   Title = "Fen Bilimleri Laboratuvarı ",
                   Slug = "fen-bilimleri-laboratuvari",
                   ParentPageId = 15,
                   Template = "Page",
                   LanguageId = 1,
                   IsPublished = true,
               ...
               new Page {
                   Title = "Güzel Sanatlar Atölyesi",
                   Slug = "guzel-sanatlar-atolyesi",
                   ParentPageId = 15,
                   Template = "Page",
                   LanguageId = 1,
                   IsPublished = true,
               ...
               new Page { Title = "İş Başvuru Formu", Slug = "is-basvuru-formu", Template = "JobApplication", LanguageId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
        ...
        private static void BilgiKoleji_AddPostPostCategories(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
        ...
        private static void BilgiKoleji_AddGalleryItemGalleryItemCategories(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
        ...
        private static void BilgiKoleji_AddPostCategories(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
        ...
        private static void BilgiKoleji_AddPosts(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
        ...
        private static void BilgiKoleji_AddFeedbackValues(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
        ...
        private static void BilgiKoleji_AddFeedbacks(ApplicationDbContext context, AppTenant tenant)
        {
           /* context.AddRange(
        ...
        private static void BilgiKoleji_AddSettings(ApplicationDbContext context,AppTenant tenant)
        {
            var s = new Setting();
            ...
            s.MapLat = "40.9952344";
            s.MapLon = "29.1422863";
            s.MapTitle = "Bilgi Koleji Ataşehir Kampüsü";
            context.Settings.Add(s);
            context.SaveChanges();
            
           
        }
        public static void BilgiKoleji_AddCustomization(ApplicationDbContext context, AppTenant tenant)
        {
        ...
        private static void BilgiKoleji_AddForms(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
                ...
                new Form { FormName = "İlkOkul iletişim", Slug = "ilkokul-iletisim", EmailTo = "mdemirci@outlook.com", LanguageId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId }
                );
            context.SaveChanges();
        }

        private static void BilgiKoleji_AddFormFields(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
        ...
        private static void BilgiKoleji_AddMenus(ApplicationDbContext context, AppTenant tenant)
        {
        ...
        private static void BilgiKoleji_AddMenuItems(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
        ...
        private static void BilgiKoleji_AddHomePageSlider(ApplicationDbContext context, AppTenant tenant)
        {
        ...
        private static void BilgiKoleji_AddHomePageSlides(ApplicationDbContext context, AppTenant tenant)
        {
            var s1 = new Slide();
        ...
        private static void BilgiKoleji_AddSecondarySlider(ApplicationDbContext context, AppTenant tenant)
        {
            var slider = new Slider();
            slider.AppTenantId = tenant.AppTenantId;
        ...
        private static void BilgiKoleji_AddSecondarySlides(ApplicationDbContext context, AppTenant tenant)
        {
            var s1 = new Slide();
            s1.AppTenantId = tenant.AppTenantId;
        ...
        private static void BilgiKoleji_AddLogoSlider(ApplicationDbContext context, AppTenant tenant)
        {
            var slider = new Slider();
            slider.AppTenantId = tenant.AppTenantId;
        ...
        private static void BilgiKoleji_AddLogoSlides(ApplicationDbContext context, AppTenant tenant)
        {
        ...
        private static void BilgiKoleji_AddGalleries(ApplicationDbContext context,AppTenant tenant)
        {
        ...
        private static void BilgiKoleji_AddGalleryItemCategories(ApplicationDbContext context, AppTenant tenant)
        {
        ...
        private static void BilgiKoleji_AddGalleryItems(ApplicationDbContext context,AppTenant tenant)
        {
        ...
        private static void BilgiKoleji_AddResources(ApplicationDbContext context, AppTenant tenant)
        {
        ...
        private static void BirInsanBelge_AddPostPostCategories(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
                new PostPostCategory { PostId = 1, PostCategoryId = 1, AppTenantId = tenant.AppTenantId },
                new PostPostCategory { PostId = 3, PostCategoryId = 1, AppTenantId = tenant.AppTenantId },
        ...
        private static void BirInsanBelge_AddGalleryItemGalleryItemCategories(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
                new GalleryItemGalleryItemCategory { GalleryItemId = 1, GalleryItemCategoryId = 1, AppTenantId = tenant.AppTenantId },
                new GalleryItemGalleryItemCategory { GalleryItemId = 1, GalleryItemCategoryId = 2, AppTenantId = tenant.AppTenantId },
        ...
        private static void BirInsanBelge_AddPostCategories(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
                new PostCategory { CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, Description = null, LanguageId = 1, Name = "Haberler", ParentCategoryId = null, Slug = "haberler", AppTenantId = tenant.AppTenantId },
                new PostCategory { CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, Description = null, LanguageId = 1, Name = "Kadromuz", ParentCategoryId = null, Slug = "kadromuz", AppTenantId = tenant.AppTenantId },
        ...
        private static void BirInsanBelge_AddPosts(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
                new Post { CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, Body = "<p>Donec rutrum ante augue, eu rutrum turpis finibus vel. Quisque augue sapien, ornare ut turpis ac, faucibus tempus purus. Ut consectetur aliquam ligula. Phasellus efficitur at erat sit amet tincidunt. Sed pellentesque viverra posuere. Phasellus convallis at mauris quis tincidunt. Etiam condimentum odio ut vehicula eleifend. Etiam mi metus, pulvinar a iaculis eget, hendrerit sed est. Fusce felis lectus, elementum quis ultricies ullamcorper, maximus id mi. Aliquam quis finibus ipsum. Proin ut feugiat purus. Nulla in risus eleifend, sodales quam eget, volutpat leo.</p>", Description = "küçük masa lambası", IsPublished = true, LanguageId = 1, Meta1 = "meta1 nedir", Meta2 = "meta2 nedir", Photo = "/uploads/images/18.jpg", SeoDescription = "post", SeoKeywords = "post", SeoTitle = "post", Slug = "haber1", Title = "Donec rutrum ante augue, eu rutrum turpis finibus vel", ViewCount = 0, AppTenantId = tenant.AppTenantId },
                new Post { CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, Body = "<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas tincidunt risus tortor, vitae congue nisi maximus vitae. Nunc id sapien ut est ultrices porta. In euismod dui vitae metus venenatis vehicula. Pellentesque non lacinia odio. Fusce id lectus eu justo euismod congue. Suspendisse potenti. Pellentesque rhoncus volutpat orci sed maximus. Mauris volutpat quam ac dui rhoncus, vel vestibulum nisl tristique. Aliquam scelerisque nunc in consectetur porta. Fusce quis molestie lacus. Phasellus molestie egestas arcu, sit amet condimentum mauris facilisis ut. Ut tempor felis erat, vitae hendrerit felis fermentum at. Quisque risus justo, lacinia id nibh in, lacinia aliquet enim.</p>", Description = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.", IsPublished = true, LanguageId = 1, Meta1 = null, Meta2 = null, Photo = "/uploads/images/19.jpg", SeoDescription = "blog", SeoKeywords = "blog", SeoTitle = "blog", Slug = "ilk-blog-yazisi", Title = "İlk blog yazısı", ViewCount = 0, AppTenantId = tenant.AppTenantId },
        ...
        private static void BirInsanBelge_AddFeedbackValues(ApplicationDbContext context, AppTenant tenant)
        {
            /*context.AddRange(
                new FeedbackValue { CreatedBy = "username", CreateDate = DateTime.Now, FeedbackId = 1, FieldType = FieldType.fullName, FormFieldId = 1, FormFieldName = "Ad Soyad", UpdatedBy = "username", UpdateDate = DateTime.Now, Position = 1, AppTenantId = tenant.AppTenantId },
        ...
        private static void BirInsanBelge_AddFeedbacks(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
                new Feedback { CreatedBy = "username", CreateDate = DateTime.Now, FormId = 1, FormName = "Sizi Arayalım", UpdatedBy = "username", UpdateDate = DateTime.Now, UserName = "username", SentDate = DateTime.Now, AppTenantId = tenant.AppTenantId }
        ...
        public static long BirInsanBelge_AddLanguages(ApplicationDbContext context, AppTenant tenant)
        {
            var l = new Language();
            l.Name = "Turkish";
            l.NativeName = "Türkçe";
        ...
        public static void BirInsanBelge_AddPages(ApplicationDbContext context, AppTenant tenant, long languageId)
        {
        ...
        private static void BirInsanBelge_AddSettings(ApplicationDbContext context, AppTenant tenant)
        {
            var s = new Setting();
            s.AppTenantId = tenant.AppTenantId;
            s.HeaderString = "";
        ...
        public static void BirInsanBelge_AddCustomization(ApplicationDbContext context, AppTenant tenant)
        {
            var customization = new Customization();
            customization.AppTenantId = tenant.AppTenantId;
            customization.ThemeId = tenant.ThemeId;
        ...
        private static void BirInsanBelge_AddForms(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
                new Form { FormName = "Sizi Arayalım", Slug = "sizi-arayalim", EmailTo = "mdemirci@outlook.com", LanguageId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                new Form { FormName = "İletişim", Slug = "iletisim", EmailTo = "mdemirci@outlook.com", LanguageId = 1, IsPublished = true, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId }
        ...
        private static void BirInsanBelge_AddFormFields(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
                new FormField { Name = "Ad Soyad", FormId = 1, FieldType = FieldType.fullName, Position = 1, Required = true, Value = "", CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
                new FormField { Name = "E-posta", FormId = 1, FieldType = FieldType.email, Position = 2, Required = true, Value = "", CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId },
        ...
        private static void BirInsanBelge_AddMenus(ApplicationDbContext context, AppTenant tenant)
        {
            var menu = new Menu { Name = "Ana Menü", MenuLocation = "Primary", LanguageId = 1, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId };
            var menu2 = new Menu { Name = "Home Menu", MenuLocation = "Primary", LanguageId = 2, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId };
        ...
        private static void BirInsanBelge_AddMenuItems(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
        ...
        private static void BirInsanBelge_AddHomePageSlider(ApplicationDbContext context, AppTenant tenant)
        {
            var slider = new Slider();
            slider.AppTenantId = tenant.AppTenantId;
        ...
        private static void BirInsanBelge_AddHomePageSlides(ApplicationDbContext context, AppTenant tenant)
        {
        ...
        private static void BirInsanBelge_AddSecondarySlider(ApplicationDbContext context, AppTenant tenant)
        {
            var slider = new Slider();
            slider.AppTenantId = tenant.AppTenantId;
        ...
        private static void BirInsanBelge_AddSecondarySlides(ApplicationDbContext context, AppTenant tenant)
        {
            var s1 = new Slide();
            s1.AppTenantId = tenant.AppTenantId;
        ...
        private static void BirInsanBelge_AddLogoSlider(ApplicationDbContext context, AppTenant tenant)
        {
            var slider = new Slider();
            slider.AppTenantId = tenant.AppTenantId;
        ...
        private static void BirInsanBelge_AddLogoSlides(ApplicationDbContext context, AppTenant tenant)
        {
        ...
        private static void BirInsanBelge_AddGalleries(ApplicationDbContext context, AppTenant tenant)
        {
        ...
        private static void BirInsanBelge_AddGalleryItemCategories(ApplicationDbContext context, AppTenant tenant)
        {
        ...
        private static void BirInsanBelge_AddGalleryItems(ApplicationDbContext context, AppTenant tenant)
        {
        ...
        private static void BirInsanBelge_AddResources(ApplicationDbContext context, AppTenant tenant)
        {
        ...
        /*********************************** Bilgi Store *****************************/
        public static long BilgiStore_AddLanguages(ApplicationDbContext context, AppTenant tenant)
        {
            var l = new Language();
            l.Name = "Turkish";
            l.NativeName = "Türkçe";
        ...
        public static void BilgiStore_AddPages(ApplicationDbContext context, AppTenant tenant, long languageId)
        {
        ...
        private static void BilgiStore_AddSettings(ApplicationDbContext context, AppTenant tenant)
        {
            var s = new Setting();
            s.AppTenantId = tenant.AppTenantId;
            s.HeaderString = "";
        ...
        public static void BilgiStore_AddCustomization(ApplicationDbContext context, AppTenant tenant)
        {
            var customization = new Customization();
            customization.AppTenantId = tenant.AppTenantId;
            customization.ThemeId = tenant.ThemeId;
        ...
        private static void BilgiStore_AddMenus(ApplicationDbContext context, AppTenant tenant)
        {
            var menu = new Menu { Name = "Ana Menü", MenuLocation = "Primary", LanguageId = 1, CreatedBy = "username", CreateDate = DateTime.Now, UpdatedBy = "username", UpdateDate = DateTime.Now, AppTenantId = tenant.AppTenantId };
        ...
        private static void BilgiStore_AddMenuItems(ApplicationDbContext context, AppTenant tenant)
        {
            context.AddRange(
        ...
        private static void BilgiStore_AddHomePageSlider(ApplicationDbContext context, AppTenant tenant)
        {
            var slider = new Slider();
            slider.AppTenantId = tenant.AppTenantId;
        ...
        private static void BilgiStore_AddHomePageSlides(ApplicationDbContext context, AppTenant tenant)
        {
        ...
        private static void AddRoles(RoleManager<Role> _roleManager, string tenantId)
        {
            ...
            "AttributeItemIndex","AttributeItemCreate","AttributeItemEdit","AttributeItemDelete",
        ...
        private static void AddRolesToUsers(UserManager<ApplicationUser> _userManager)
        {
