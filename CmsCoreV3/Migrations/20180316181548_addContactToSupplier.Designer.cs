...
namespace CmsCoreV3.Migrations
{
    ...
    [Migration("20180316181548_addContactToSupplier")]
    partial class addContactToSupplier
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CmsCoreV3.Models.ProductProductTag", b =>
                {
                    b.Property<long>("ProductId");
            ...
            modelBuilder.Entity("CmsCoreV3.Models.ProductTag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CmsCoreV3.Models.SaleRegion", b =>
                {
            ...
            modelBuilder.Entity("CmsCoreV3.Models.SettingRegion", b =>
                {
                    b.Property<long>("SettingId");
            ...
            modelBuilder.Entity("CmsCoreV3.Models.ShippingRegion", b =>
                {
                    b.Property<long>("SettingId");
            ...
            modelBuilder.Entity("CmsCoreV3.Models.AttributeItem", b =>
                {
                    b.HasOne("CmsCoreV3.Models.Attribute", "ProductAttribute")
            ...
            modelBuilder.Entity("CmsCoreV3.Models.Product", b =>
                {
                    b.HasOne("CmsCoreV3.Models.Product", "CrossSell")
                        .WithMany("CrossSells")
                        .HasForeignKey("CrossSellId");

                    b.HasOne("CmsCoreV3.Models.Product", "GroupedProduct")
                    ...
                    b.HasOne("CmsCoreV3.Models.Product", "UpSell")
                        .WithMany("UpSells")
            ...
            modelBuilder.Entity("CmsCoreV3.Models.ProductMedia", b =>
                {
                    b.HasOne("CmsCoreV3.Models.Media", "Media")
            ...
            modelBuilder.Entity("CmsCoreV3.Models.ProductProductTag", b =>
                {
                    ...
                    b.HasOne("CmsCoreV3.Models.ProductTag", "ProductTag")
                        .WithMany("ProductProductTags")
            ...
            modelBuilder.Entity("CmsCoreV3.Models.SaleRegion", b =>
                {
                    ...
                    b.HasOne("CmsCoreV3.Models.Setting", "Setting")
                        .WithMany("SalesLocations")
